    ...
    return (
        <>
            ...
            <div className="min-h-screen flex  flex-col items-center justify-center py-6 px-4 sm:px-6 lg:px-8">
                ...
                <div className="max-w-4xl w-full space-y-8 p-8 bg-gray-100 rounded-lg shadow-md">
                    <div className="flex justify-between">
                        <div className="relative flex-grow">
                            ...
                            <button
                                ...
                                className=" right-0 top-0 bottom-0 px-4 py-2 bg-black text-white
                                bg-purple-700 hover:bg-purple-800 focus:outline-none focus:ring-4 focus:ring-purple-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900"
                            >
                                Search 🔍
                            </button>
                        </div>
                    ...
                    <div className="flex justify-center mt-4">
                        <button
                            ...
                            disabled={offset === 0}
                            className="bg-white text-black-800  py-2 px-4 border  rounded-lg shadow-sm disabled:opacity-40 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 mr-2"
                        >
                            ⬅️ Previous
                        </button>
                        <button
                            ...
                            className="bg-white text-black-800  py-2 px-4 border rounded-lg shadow-sm disabled:opacity-40 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
                        >
                            Next ➡️
                        </button>
                    </div>
                ...
                <button
                    className="text-white mt-4 bg-blue-500 hover:bg-red-600 py-2 px-4 rounded-lg"
