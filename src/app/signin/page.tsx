                        ...
                        <div>
                            ...
                            <div className="mt-2">
                                <input
                                    ...
                                    required
                                    className="block w-full rounded-lg border-black-300 bg-white py-2 px-4 text-gray-800 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent sm:text-sm"
                                    placeholder="Enter your email here, example: giphy@gmail.com"
                                />
                            </div>
                        </div>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <div className="text-sm">
                                    <div
                                        ...
                                        className="cursor-pointer font-semibold text-green-500 hover:text-white-600"
                                    >
                                        Forgot password?
                                    </div>
                                </div>
